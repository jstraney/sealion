...
const
stringTypeValidator = new TypeValidator((a) => typeof a === 'string', 'String'),
boolTypeValidator = new TypeValidator((a) => typeof a === 'boolean', 'Boolean'),
floatTypeValidator = new TypeValidator((a) => typeof a === 'number' && !Number.isInteger(a), 'Decimal'),
intTypeValidator = new TypeValidator((a) => Number.isInteger(a), 'Integer');
...
const validate = async (name, value, type) => {
  ...
  const typeValidators = await invokeReduce('typeValidator', {
    ...
    text: [stringTypeValidator],
    integer: [intTypeValidator],
    increments: [intTypeValidator],
    boolean: [boolTypeValidator],
    decimal: [floatTypeValidator],
  });
